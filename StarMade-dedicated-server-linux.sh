#!/bin/bash
# StarMade Dedicated Server Launch Script for Linux
...
# Launch StarMade server (using Linux native library path)
"$JAVA_PATH" "-Djava.library.path=lib:native/linux" -jar StarMade.jar -server "-port:$PORT"

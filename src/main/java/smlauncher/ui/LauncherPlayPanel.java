...
/**
 * Panel for the play mode of the launcher.
 * Contains the launch and update buttons.
 */
public class LauncherPlayPanel extends JPanel {
	...
	public LauncherPlayPanel(StarMadeLauncher launcher) {
		super(true);
